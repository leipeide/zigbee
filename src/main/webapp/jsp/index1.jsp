...
<!-- 添加判断集控器广播的状态，页面广播按钮显示两种不同的情况，1.广播按钮为ON,DIM; 2.广播按钮为OFF,DIM -->
	<script  type="text/html" id="barBroadcast">
		 {{#  if(d.switchStatus == 1){ }}
			<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="closeBroadcast"><spring:message code="OFF" /></a>
  			<a class="layui-btn layui-btn-green layui-btn-xs" lay-event="dimBroadcast"><spring:message code="DIM" /></a>
    	 {{#  } else { }}
			<a class="layui-btn layui-btn-green layui-btn-xs" style="width: 35px; height: 24px" lay-event="openBroadcast"><spring:message code="ON" /></a>
  			<a class="layui-btn layui-btn-green layui-btn-xs" lay-event="dimBroadcast"><spring:message code="DIM" /></a>
    	 {{#  } }}
    </script>
...
<!--     
    ...
    <script  type="text/html" id="barZigbeeBroadcast">
		 {{#  if(d.zigbeeStatus == 1){ }}
			<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="closeZigbeeBroadcast"><spring:message code="OFF" /></a>
  			<a class="layui-btn layui-btn-green layui-btn-xs" lay-event="dimZigeeBroadcast"><spring:message code="DIM" /></a>
    	 {{#  } else { }}
			<a class="layui-btn layui-btn-green layui-btn-xs" style="width: 35px; height: 24px" lay-event="openZigbeeBroadcast"><spring:message code="ON" /></a>
  			<a class="layui-btn layui-btn-green layui-btn-xs" lay-event="dimZigeeBroadcast"><spring:message code="DIM" /></a>
    	 {{#  } }}
    </script>
...
<!--   同集控器广播注释 
    ...
    <script  type="text/html" id="barGroupBroadcast"> 
		 {{#  if(d.switchStatus == 1){ }}
			<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="closeGroupBroadcast"><spring:message code="OFF" /></a>
  			<a class="layui-btn layui-btn-green layui-btn-xs" lay-event="dimGroupBroadcast"><spring:message code="DIM"/></a>
    	 {{#  } else { }}
			<a class="layui-btn layui-btn-green layui-btn-xs" style="width: 35px; height: 24px" lay-event="openGroupBroadcast"><spring:message code="ON"/></a>
  			<a class="layui-btn layui-btn-green layui-btn-xs" lay-event="dimGroupBroadcast"><spring:message code="DIM"/></a>
    	 {{#  } }}
    </script>
...
<!--
	...
	<script  type="text/html" id="barSingleZbBroadcast"> 
		 {{#  if(d.zigbeeStatus == 1){ }}
			<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="closeZbBroadcastInGroup"><spring:message code="OFF" /></a>
  			<a class="layui-btn layui-btn-green layui-btn-xs" lay-event="dimZbBroadcastInGroup"><spring:message code="DIM" /></a>
    	 {{#  } else { }}
			<a class="layui-btn layui-btn-green layui-btn-xs" style="width: 35px; height: 24px" lay-event="openZbBroadcastInGroup"><spring:message code="ON" /></a>
  			<a class="layui-btn layui-btn-green layui-btn-xs" lay-event="dimZbBroadcastInGroup"><spring:message code="DIM" /></a>
    	 {{#  } }}
    </script>  
 <%-- **********************Ploy表格的toolbar或templet *********************** --%>    
    ...
    <script type="text/html" id="temPloyControl">
   		 {{#  if(d.status == 1){ }}
      		<a class="layui-btn layui-btn-danger layui-btn-xs"  style="width: 37px; height: 24px" lay-event="stopPloy"><spring:message code="Stop"/></a>
    	 {{#  } else { }}
			<a class="layui-btn layui-btn-green layui-btn-xs" style="width: 37px; height: 24px" lay-event="runPloy"><spring:message code="Run"/></a>
    	 {{#  } }}
    </script> 
