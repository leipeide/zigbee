...
public interface ZigbeeMapper {
	...
	ArrayList<Zigbee> selectByDevMacPaged(@Param("devMac") String devMac, @Param("index") int index,
			@Param("limit") int limit);

	ArrayList<Zigbee> selectByDevMacAndOnlineStatusPaged(@Param("devMac") String devMac, @Param("zigbeeNet") int zigbeeNet,
