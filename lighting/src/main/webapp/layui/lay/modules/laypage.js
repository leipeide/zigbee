/** layui-v2.5.2 MIT License By https://www.layui.com */
 ;layui.define(function(e){
	...
	u.prototype.view=function(){
		...
		a.prev="prev"in a?a.prev:"&#x4E0A;&#x4E00;&#x9875;", //上一页
		a.next="next"in a?a.next:"&#x4E0B;&#x4E00;&#x9875;";//下一页
		...
		i={prev:function(){
			...
			page:function(){
				...
				r=n>1?a.curr-i:1,u=n>1?function(){
					var e=a.curr+(t-i-1);
					return e>a.pages?a.pages:e}():t;
					for(u-r<t-1&&(r=u-t+1),
						a.first!==!1&&r>2&&e.push('<span class="layui-laypage-spr">&#x2026;</span>');//....
						r<=u;r++)r===a.curr?e.push('<span class="layui-laypage-curr"><em class="layui-laypage-em" '+(/^#/.test(a.theme)?'style="background-color:'+a.theme+';"':"")+"></em><em>"+r+"</em></span>"):e.push('<a href="javascript:;" data-page="'+r+'">'+r+"</a>");
						return a.pages>t&&a.pages>u&&a.last!==!1&&(u+1<a.pages&&e.push('<span class="layui-laypage-spr">&#x2026;</span>'),
								...
								next:function(){
									...
									//1.分页中英文翻译
									//count:'<span class="layui-laypage-count">Total(共) '+a.count+" Num(条)</span>",
									count:'<span class="layui-laypage-count">total '+a.count+" </span>",
										limit:function(){
											var e=['<span class="layui-laypage-limits"><select lay-ignore>'];
											return layui.each(a.limits,function(t,n){
												//2.中英文翻译
												//e.push('<option value="'+n+'"'+(n===a.limit?"selected":"")+">"+n+" Num(条)/Page(页)</option>")}),
												e.push('<option value="'+n+'"'+(n===a.limit?"selected":"")+">"+n+" num/page</option>")}),
												e.join("")+"</select></span>"}(),
												refresh:['<a href="javascript:;" data-page="'+a.curr+'" class="layui-laypage-refresh">',
													...
													skip:function(){
														...
														return['<span class="layui-laypage-skip">to',
		...
		return['<div class="layui-box layui-laypage layui-laypage-'+(a.theme?/^#/.test(a.theme)?"molv":a.theme:"default")+'" id="layui-laypage-'+a.index+'">',
			function(){
				...
				return layui.each(a.layout,function(a,t){
					i[t]&&e.push(i[t])}),e.join("")}(),"</div>"].join("")},
						...
						if(e){
							...
							c=function(){
								...
								for(var o=0,y=r.length;o<y;o++)"a"===r[o].nodeName.toLowerCase()&&s.on(r[o],"click",function(){
									...
									e<1||e>i.pages||(i.curr=e,t.render())});p&&s.on(p,"change",function(){
										var e=this.value;
								...
								u.prototype.render=function(e){
										...
										n.jump(s),i.hash&&!e&&(location.hash="!"+i.hash+"="+i.curr),
										n.skip(s)
										};
								...
								index:layui.laypage?layui.laypage.index+1e4:0,on:function(e,a,t){
									return e.attachEvent?e.attachEvent("on"+a,function(a){
										a.target=a.srcElement,t.call(e,a)}):e.addEventListener(a,t,!1),this}
								};e(i,s)});